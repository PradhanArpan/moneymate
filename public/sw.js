const V="mm-v10-9";
const CORE=["/","/index.html","/manifest.webmanifest","/moneymate-icon-192.png","/moneymate-icon-512.png","/apple-touch-icon.png","/moneymate-icon.svg","/manifest.json","/icon-192.png","/icon-512.png"];
